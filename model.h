...
class Model
{
    private:
        ...
        QList<MadPerso *> *listMadPersoMobile = new QList<MadPerso *>;
    ...
    public:
        ...
        void addMadPersoMobile(MadPerso *S) {listMadPersoMobile->append(S);}
        ...
        QList<MadPerso *> *getlistMadPersoMobile() {return this->listMadPersoMobile;}
